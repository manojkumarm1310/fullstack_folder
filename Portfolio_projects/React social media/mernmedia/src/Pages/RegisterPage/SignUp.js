...
const SignUp = () => {
    ...
    const handleSignUp=(e)=>{
        e.preventDefault()
       let signupvalidation=validation(data);
       setError(signupvalidation);
       console.log(signupvalidation)
       setSubmit(true)
       console.log(signupvalidation);
       if(signupvalidation.email=="" && signupvalidation.password=="" && signupvalidation.confirmpassword==""&& signupvalidation.fullname=="")
       {
        navigate("/")
       }
    }
